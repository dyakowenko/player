"object" == typeof navigator && function (e, t) {
    ...
    var A, E, S, P = function () {
        function t(i, n) {
            e(this, t),
                w(i) ? this.element = i : y(i) && (this.element = document.querySelector(i)),
                w(this.element) && T(this.element.rangeTouch) && (this.config = Object.assign({}, l, n),
                    this.init())
        }
        return i(t, [{
            key: "init",
            ...
            value: function (e) {
                if (!t.enabled || !k(e))
                    return null;
                var i, n = e.target, a = e.changedTouches[0], s = parseFloat(n.getAttribute("min")) || 0, r = parseFloat(n.getAttribute("max")) || 100, o = parseFloat(n.getAttribute("step")) || 1, l = r - s, c = n.getBoundingClientRect(), u = 100 / c.width * (this.config.thumbWidth / 2) / 100;
                return (i = 100 / c.width * (a.clientX - c.left)) < 0 ? i = 0 : i > 100 && (i = 100),
                    i < 50 ? i -= (100 - 2 * i) * u : i > 50 && (i += 2 * (i - 50) * u),
                    s + C(l * (i / 100), o)
            }
        }, {
            key: "set",
            value: function (e) {
                t.enabled && k(e) && !e.target.disabled && (e.preventDefault(),
            ...
            value: function (e) {
                var i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
                    , n = null;
                if (T(e) || y(e) ? n = Array.from(document.querySelectorAll(y(e) ? e : 'input[type="range"]')) : w(e) ? n = [e] : b(e) ? n = Array.from(e) : v(e) && (n = e.filter(w)),
                    T(n))
                    return null;
    ...
    }, q = x, H = I, D = function (e) {
        return M(e) === Number && !Number.isNaN(e)
    }, F = L, R = function (e) {
        return M(e) === Boolean
    }, V = function (e) {
        return M(e) === Function
    }, B = _, U = O, W = function (e) {
        return N(e, Element)
    }, z = function (e) {
        return N(e, Event)
    }, K = function (e) {
    ...
    }, X = j, J = (A = document.createElement("span"),
        E = {
    ...
    function ee() {
        ...
        return H(s) ? (Object.keys(s).forEach((function (t) {
            H(s[t]) ? (Object.keys(e).includes(t) || Object.assign(e, n({}, t, {})),
                ee(e[t], s[t])) : Object.assign(e, n({}, t, s[t]))
        }
        )),
    ...
    var ge, ye = {
        ...
        rangeInput: (ge = document.createElement("input"),
            ge.type = "range",
            "range" === ge.type),
    ...
    function Ne(e) {
        ...
        if (null === i && (i = t(this.config.ratio)),
            null === i && !X(this.embed) && B(this.embed.ratio) && (i = this.embed.ratio),
            null === i && this.isHTML5) {
            var n = this.media;
    ...
    var Ie = {
        ...
        cancelRequests: function () {
            this.isHTML5 && (se(Ie.getSources.call(this)),
    ...
    var Ye = {
        ...
        findElements: function () {
            try {
                return this.elements.controls = me.call(this, this.config.selectors.controls.wrapper),
        ...
        createButton: function (e, t) {
            ...
            return s.toggle ? (r.appendChild(Ye.createIcon.call(this, s.iconPressed, {
                ...
                ie(r, n),
                "play" === a ? (B(this.elements.buttons[a]) || (this.elements.buttons[a] = []),
        ...
        bindMenuItemShortcuts: function (e, t) {
            ...
            ke.call(this, e, "keydown keyup", (function (n) {
                if ([32, 38, 39, 40].includes(n.which) && (n.preventDefault(),
                    n.stopPropagation(),
                    "keydown" !== n.type)) {
                    var a, s = he(e, '[role="menuitemradio"]');
        ...
        updateVolume: function () {
            this.supported.ui && (W(this.elements.inputs.volume) && Ye.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
                W(this.elements.buttons.mute) && (this.elements.buttons.mute.pressed = this.muted || 0 === this.volume))
        },
        setRange: function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0;
            W(e) && (e.value = t,
                Ye.updateRangeFill.call(this, e))
        },
            ...
            if (this.config.tooltips.seek && W(this.elements.inputs.seek) && W(this.elements.display.seekTooltip) && 0 !== this.duration) {
                ...
                if (this.touch)
                    ...
                    if (z(e))
                        ...
                        if (!de(this.elements.display.seekTooltip, i))
                            return;
        ...
        timeUpdate: function (e) {
            ...
            Ye.updateTimeDisplay.call(this, this.elements.display.currentTime, t ? this.duration - this.currentTime : this.currentTime, t),
                e && "timeupdate" === e.type && this.media.seeking || Ye.updateProgress.call(this, e)
        },
        durationUpdate: function () {
            if (this.supported.ui && (this.config.invertTime || !this.currentTime)) {
                if (this.duration >= Math.pow(2, 32))
                    return ce(this.elements.display.currentTime, !0),
        ...
        updateSetting: function (e, t, i) {
            ...
            if (W(s) || (s = n && n.querySelector('[role="menu"]')),
                W(s)) {
        ...
        setQualityMenu: function (e) {
            ...
            if (W(this.elements.settings.panels.quality)) {
                ...
                if (Ye.toggleMenuButton.call(this, "quality", n),
                    re(i),
        ...
        setCaptionsMenu: function () {
            ...
            if (W(this.elements.settings.panels.captions)) {
                var t = this.elements.settings.panels.captions.querySelector('[role="menu"]')
                    ...
                    , n = Boolean(i.length);
                if (Ye.toggleMenuButton.call(this, "captions", n),
                    re(t),
                    Ye.checkMenu.call(this),
                    n) {
        ...
        toggleMenu: function (e) {
            ...
            if (W(t) && W(i)) {
                ...
                i.setAttribute("aria-expanded", a),
                    ...
                    a && K(e) ? Ye.focusFirstMenuItem.call(this, null, !0) : a || n || fe.call(this, i, K(e))
            }
        },
        ...
        showMenuPanel: function () {
            ...
            if (W(n)) {
                ...
                ce(s, !0),
                    ce(n, !1),
                    Ye.focusFirstMenuItem.call(this, n, i)
            }
        },
        ...
        create: function (e) {
            ...
            return Le(this.config.controls).forEach((function (o) {
                    ...
                    b.appendChild(w),
                        ...
                        t.config.settings.forEach((function (n) {
                            ...
                            l.appendChild(ne("span", {
                                ...
                                ke.call(t, o, "keydown", (function (e) {
                ...
                if ("pip" === o && ve.pip && u.appendChild(n.call(t, "pip", d)),
                    "airplay" === o && ve.airplay && u.appendChild(n.call(t, "airplay", d)),
                    "download" === o) {
                    var k = ee({}, d, {
                        element: "a",
                        href: t.download,
        ...
        inject: function () {
            ...
            V(this.config.controls) && (this.config.controls = this.config.controls.call(this, n)),
                ...
                W(this.config.controls) || F(this.config.controls) ? i = this.config.controls : (i = Ye.create.call(this, {
                    id: this.id,
                    seektime: this.config.seekTime,
                    speed: this.speed,
            ...
            if (a && (F(this.config.controls) ? i = o(i) : W(i) && (i.innerHTML = o(i.innerHTML))),
    ...
    var Je = {
        setup: function () {
            if (this.supported.ui)
                if (!this.isVideo || this.isYouTube || this.isHTML5 && !ve.textTracks)
                    ...
                    if (W(this.elements.captions) || (this.elements.captions = ne("div", le(this.config.selectors.captions)),
                        function (e, t) {
                    ...
                    if (R(n) || (n = this.config.captions.active),
        ...
        update: function () {
            ...
            this.isHTML5 && this.isVideo && t.filter((function (e) {
                ...
                (o && this.language !== a || !t.includes(r)) && (Je.setLanguage.call(this, a),
                    Je.toggle.call(this, n && o)),
        ...
        findTrack: function (e) {
            var t, i = this, n = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], a = Je.getTracks.call(this), s = function (e) {
        ...
        getLabel: function (e) {
            var t = e;
            return !Y(t) && ve.textTracks && this.captions.toggled && (t = Je.getCurrentTrack.call(this)),
    ...
    var nt = function () { }
        ...
        , st = function () {
            ...
            return i(t, [{
                ...
                value: function () {
                    if (this.enabled) {
                        ...
                        W(e) && (e.pressed = this.active),
                            Ae.call(this.player, this.target, this.active ? "enterfullscreen" : "exitfullscreen", !0)
                    }
                }
            }, {
                key: "toggleFallback",
                ...
                key: "prefix",
                get: function () {
                    if (V(document.exitFullscreen))
                        return "";
                    var e = "";
                    return ["webkit", "moz", "ms"].some((function (t) {
                        return !(!V(document["".concat(t, "ExitFullscreen")]) && !V(document["".concat(t, "CancelFullScreen")])) && (e = t,
                            !0)
                    }
                    )),
                        e
    ...
    var ot = {
        addStyleHook: function () {
            ue(this.elements.container, this.config.selectors.container.replace(".", ""), !0),
                ue(this.elements.container, this.config.classNames.uiSupported, this.supported.ui)
        },
        ...
        build: function () {
            ...
            W(this.elements.controls) || (Ye.inject.call(this),
        ...
        setTitle: function () {
            ...
            if (F(this.config.title) && !X(this.config.title) && (e += ", ".concat(this.config.title)),
        ...
        setPoster: function (e) {
            var t = this
                , i = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
            return i && this.poster ? Promise.reject(new Error("Poster already set")) : (this.media.setAttribute("poster", e),
                this.isHTML5 ? Promise.resolve(e) : Se.call(this).then((function () {
                    return rt(e)
                }
                )).catch((function (i) {
                    throw e === t.poster && ot.togglePoster.call(t, !1),
                    i
                }
                )).then((function () {
                    if (e !== t.poster)
        ...
        checkLoading: function (e) {
            ...
            this.loading = ["stalled", "waiting"].includes(e.type),
                ...
                this.timers.loading = setTimeout((function () {
                    ue(t.elements.container, t.config.classNames.loading, t.loading),
                    ...
                    !t.keyboard.global && t.keyboard.focused && ke.call(e, i.container, "keydown keyup", this.handleKey, !1),
                        ke.call(e, i.container, "mousemove mouseleave touchstart touchmove enterfullscreen exitfullscreen", (function (t) {
                            ...
                            a && "enterfullscreen" === t.type && (a.pressed = !1,
                                a.hover = !1);
                            var s = 0;
                            ["touchstart", "touchmove", "mousemove"].includes(t.type) && (ot.toggleControls.call(e, !0),
                                s = e.touch ? 3e3 : 2e3),
                    ...
                    if (i.buttons.play && Array.from(i.buttons.play).forEach((function (i) {
                        ...
                        this.bind(i.buttons.settings, "keyup", (function (e) {
                            ...
                            [13, 32].includes(i) && (13 !== i ? (e.preventDefault(),
                                e.stopPropagation(),
                                Ye.toggleMenu.call(t, e)) : Ye.focusFirstMenuItem.call(t, null, !0))
                        }
                        ), null, !1),
                        ...
                        this.bind(i.inputs.seek, "mousedown mouseup keydown keyup touchstart touchend", (function (e) {
                            ...
                            if (!K(e) || 39 === n || 37 === n) {
                                ...
                                a && s ? (i.removeAttribute("play-on-seeked"),
                                    t.play()) : !s && t.playing && (i.setAttribute("play-on-seeked", ""),
                                        t.pause())
                            }
                        }
                        )),
    ...
    var ht = {
        setup: function () {
            ...
            ue(e.elements.wrapper, e.config.classNames.embed, !0),
                e.options.speed = e.config.speed.options,
                xe.call(e),
                H(window.Vimeo) ? ht.ready.call(e) : ut(e.config.urls.vimeo.sdk).then((function () {
                    ht.ready.call(e)
                }
                )).catch((function (t) {
        ...
        ready: function () {
            ...
            var s, o = X(s = a) ? null : D(Number(s)) ? s : s.match(/^.*(vimeo.com\/|video\/)(\d+).*/) ? RegExp.$2 : s, l = ne("iframe"), c = _e(t.config.urls.vimeo.iframe, o, n);
            l.setAttribute("src", c),
                l.setAttribute("allowfullscreen", ""),
                l.setAttribute("allowtransparency", ""),
                l.setAttribute("allow", "autoplay"),
                X(i.referrerPolicy) || l.setAttribute("referrerPolicy", i.referrerPolicy);
            var u = ne("div", {
                poster: t.poster,
            ...
            Object.defineProperty(t.media, "volume", {
                ...
                set: function (e) {
                    t.embed.setVolume(e).then((function () {
                        p = e,
                            Ae.call(t, t.media, "volumechange")
                    }
                    ))
                }
            });
            ...
            Object.defineProperty(t.media, "loop", {
                ...
                t.embed.on("seeked", (function () {
                    t.media.seeking = !1,
                        Ae.call(t, t.media, "seeked")
                }
                )),
                t.embed.on("ended", (function () {
                    t.media.paused = !0,
                        Ae.call(t, t.media, "ended")
                }
                )),
                t.embed.on("error", (function (e) {
                    t.media.error = e,
                        Ae.call(t, t.media, "error")
                }
                )),
                setTimeout((function () {
    ...
    var ft = {
        setup: function () {
            var e = this;
            if (ue(this.elements.wrapper, this.config.classNames.embed, !0),
        ...
        ready: function () {
            ...
            if (X(t) || !t.startsWith("youtube-")) {
                ...
                var n, a, s = X(n = i) ? null : n.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*/) ? RegExp.$2 : n, r = (a = e.provider,
                    "".concat(a, "-").concat(Math.floor(1e4 * Math.random()))), o = ne("div", {
                        id: r,
                        poster: e.poster
                    });
                                ...
                                case 0:
                                    pt.call(e, !1),
                                        e.media.loop ? (i.stopVideo(),
                                            i.playVideo()) : Ae.call(e, e.media, "ended");
                                    break;
                                case 1:
                                    e.config.autoplay || !e.media.paused || e.embed.hasPlayed ? (pt.call(e, !0),
                                        ...
                                        e.media.duration !== i.getDuration() && (e.media.duration = i.getDuration(),
                                            Ae.call(e, e.media, "durationchange"))) : e.media.pause();
                                    break;
                                case 2:
        ...
        , gt = {
            setup: function () {
                this.media ? (ue(this.elements.container, this.config.classNames.type.replace("{0}", this.type), !0),
                    ...
                    this.isVideo && (this.elements.wrapper = ne("div", {
                        class: this.config.classNames.video
                    }),
                        te(this.media, this.elements.wrapper),
                        this.isEmbed && (this.elements.poster = ne("div", {
                            class: this.config.classNames.poster
                        }),
                            this.elements.wrapper.appendChild(this.elements.poster))),
                    this.isHTML5 ? Ie.setup.call(this) : this.isYouTube ? ft.setup.call(this) : this.isVimeo && ht.setup.call(this)) : this.debug.warn("No media element found!")
            }
        }
        , yt = function () {
            function t(i) {
            ...
            return i(t, [{
                ...
                key: "on",
                value: function (e, t) {
                    return B(this.events[e]) || (this.events[e] = []),
                ...
                value: function (e) {
                    q(this.safetyTimer) || (this.player.debug.log("Safety timer cleared from: ".concat(e)),
        ...
        , bt = function () {
            ...
            return i(t, [{
                ...
                key: "startScrubbing",
                value: function (e) {
                    (q(e.button) || !1 === e.button || 0 === e.button) && (this.mouseDown = !0,
                ...
                value: function () {
                    var e = this;
                    this.mouseDown = !1,
                        Math.ceil(this.lastTime) === Math.ceil(this.player.media.currentTime) ? this.toggleScrubbingContainer(!1) : Ce.call(this.player, this.player.media, "timeupdate", (function () {
        ...
        , wt = {
            ...
            change: function (e) {
                var t = this;
                Z(e, "sources.length") ? (Ie.cancelRequests.call(this),
                    this.destroy.call(this, (function () {
                        t.options.quality = [],
                            se(t.media),
                            t.media = null,
                            W(t.elements.container) && t.elements.container.removeAttribute("class");
                        var i = e.sources
                            , n = e.type
                            , a = r(i, 1)[0]
                            , s = a.provider
                        ...
                        Object.assign(t, {
                            ...
                            X(e.previewThumbnails) || (Object.assign(t.config.previewThumbnails, e.previewThumbnails),
    ...
    var kt, Tt = function () {
        function t(i, n) {
            ...
            if (e(this, t),
                ...
                this.config = ee({}, $e, t.defaults, n || {}, function () {
                    try {
                    ...
                    if (ve.check().api) {
                        ...
                        switch (r) {
                            case "div":
                                ...
                                if (X(this.provider) || !Object.keys(et).includes(this.provider))
                        ...
                        this.supported = ve.check(this.type, this.provider, this.config.playsinline),
                            this.supported.api ? (this.eventListeners = [],
                                ...
                                W(this.elements.container) || (this.elements.container = ne("div", {
                                    tabindex: 0
                                }),
                                    te(this.media, this.elements.container)),
                                ot.addStyleHook.call(this),
                                gt.setup.call(this),
                                this.config.debug && ke.call(this, this.elements.container, this.config.events.join(" "), (function (e) {
                                ...
                                this.lastSeekTime = 0,
                                this.config.previewThumbnails.enabled && (this.previewThumbnails = new bt(this))) : this.debug.error("Setup failed: no support")
                    } else
        ...
        return i(t, [{
            ...
            value: function () {
                this.isHTML5 ? (this.pause(),
                    this.restart()) : V(this.media.stop) && this.media.stop()
            }
        }, {
            key: "restart",
            value: function () {
            ...
            value: function (e) {
                if (this.supported.ui && !this.isAudio) {
                    ...
                    if (n && this.config.controls.includes("settings") && !X(this.config.settings) && Ye.toggleMenu.call(this, !1),
                        n !== t) {
                ...
                if (this.ready) {
                    var n = function () {
                        document.body.style.overflow = "",
                            t.embed = null,
                            i ? (Object.keys(t.elements).length && (se(t.elements.buttons.play),
                    ...
                    this.stop(),
                        ...
                        this.isHTML5 ? (ot.toggleNativeControls.call(this, !0),
                            n()) : this.isYouTube ? (clearInterval(this.timers.buffering),
                                clearInterval(this.timers.playing),
                                null !== this.embed && V(this.embed.destroy) && this.embed.destroy(),
            ...
            set: function (e) {
                this.isVideo ? F(e) && Pe(e) ? (this.config.ratio = e,
                    xe.call(this)) : this.debug.error("Invalid aspect ratio specified (".concat(e, ")")) : this.debug.warn("Aspect ratio can only be set for video")
            }
        }, {
            key: "autoplay",
            set: function (e) {
            ...
            value: function (e) {
                var i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
                    , n = null;
                return F(e) ? n = Array.from(document.querySelectorAll(e)) : U(e) ? n = Array.from(e) : B(e) && (n = e.filter(W)),
                    X(n) ? null : n.map((function (e) {
                        return new t(e, i)
                    }
                    ))
            }
